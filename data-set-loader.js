function getGraphDataSets() {
    ...
    const loadData = function(Graph) {
        Graph
            ...
            .autoColorBy('group')
            .forceEngine('ngraph')
            .jsonUrl('http://localhost:8000/data.json');
    };
    // loadData.description = "<em>Data</em> (<a href='https://bl.ocks.org/mbostock/4062045'>4062045</a>)";
    ...
    return [loadData, loadBlocks, loadD3Dependencies, tunnel];
}